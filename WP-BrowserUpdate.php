...
function wpbu() {
  ...
  $msie      = (isset($wpbu_vars[0]) ? $wpbu_vars[0] : false);
  $firefox   = (isset($wpbu_vars[1]) ? $wpbu_vars[1] : false);
  $opera     = (isset($wpbu_vars[2]) ? $wpbu_vars[2] : false);
  $safari    = (isset($wpbu_vars[3]) ? $wpbu_vars[3] : false);
